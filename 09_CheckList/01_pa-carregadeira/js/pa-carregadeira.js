  ...
  checklists.push(
    {
      ...
      data: "2026-05-10",
      turno: "Manhã",
      condicaoOperacao: "Operando",
      respostas: [
        { pergunta: "Freios", resposta: "NC" },
        { pergunta: "Indicador de combustível", resposta: "NC" },
        { pergunta: "Buzina", resposta: "C" },
      ],
    },

    {
      ...
      respostas: [
        { pergunta: "Freios", resposta: "NC" },
        { pergunta: "Vazamento no motor", resposta: "NC" },
      ],
    },

    {
      ...
      data: "2026-03-08",
      turno: "Tarde",
      condicaoOperacao: "Parada",
      respostas: [
        { pergunta: "Freios", resposta: "NC" },
        { pergunta: "Sirene de ré", resposta: "NC" },
        { pergunta: "Giroflex", resposta: "NC" },
      ],
    },
